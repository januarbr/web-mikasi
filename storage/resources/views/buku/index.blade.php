            ...
            <div class="pricing-wrapper row text-center">
                ...
                <div class="item-inner ">
                        ...
                        <ul class="list-unstyled mb-3">
                            <li class="mb-2"> <a href="">Semester 1</a></li>
                        </ul>
                    </div>
                    <!-- item-inner -->    
                </div><!--//item-->
                ...
                <div class="item-inner ">
                        <h3 class="item-heading">MIKASI <br></h3>      
                        <ul class="list-unstyled mb-3">
                            <li class="mb-2"> <a href="">Semester 2</a></li>
                        </ul>
                    </div>
                    <!-- item-inner -->    
                </div><!--//item-->
                ...
                <div class="item-inner ">
                        <h3 class="item-heading">MIKASI <br></h3>      
                        <ul class="list-unstyled mb-3">
                            <li class="mb-2"> <a href="">Semester 3</a></li>
                        </ul>
                    </div>
                    <!-- item-inner -->    
                </div><!--//item-->
                ...
                <div class="item-inner ">
                        <h3 class="item-heading">MIKASI <br></h3>      
                        <ul class="list-unstyled mb-3">
                            <li class="mb-2"> <a href="{{url('/matakuliah')}}">Semester 4</a></li>
                        </ul>
                    </div>
                    <!-- item-inner -->    
                </div><!--//item-->
                ...
                <div class="item-inner ">
                        <h3 class="item-heading">MIKASI <br></h3>      
                        <ul class="list-unstyled mb-3">
                            <li class="mb-2"> <a href="{{url('/matakuliah')}}">Semester 5</a></li>
                        </ul>
                    </div>
                    <!-- item-inner -->    
                </div><!--//item-->
                ...
                <div class="item-inner ">
                        <h3 class="item-heading">MIKASI <br></h3>      
                        <ul class="list-unstyled mb-3">
                            <li class="mb-2"> <a href="">Semester 6</a></li>
                        </ul>
                    </div>
                    <!-- item-inner -->    
                </div><!--//item-->
                ...
                <div class="item-inner ">
                        <h3 class="item-heading">MIKASI <br></h3>      
                        <ul class="list-unstyled mb-3">
                            <li class="mb-2"> <a href="">Semester 7</a></li>
                        </ul>
                    </div>
                    <!-- item-inner -->    
                </div><!--//item-->

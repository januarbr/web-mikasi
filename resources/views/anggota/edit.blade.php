            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" style="height:150px" name="alamat_anggota" value="{{$anggota->alamat_anggota}}" placeholder="Alamat_Anggota">{{$anggota->alamat_anggota}}</textarea>
